    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-slate-900 rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Asigna este paso a alguien</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-4 bg-white/[0.02] border-b border-white/5">
          <p className="text-xs text-slate-500 uppercase tracking-wide mb-1">Paso</p>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Ej: ¿Me puedes ayudar con esto cuando puedas?"
