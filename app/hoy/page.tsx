...
function HoyPageContent() {
  ...
  // Save WhatsApp phone number and activate
  const handleSaveWhatsappPhone = async () => {
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        ...
        // Activate immediately - no step 2 needed with templates
        setWhatsappConfigured(true);
        ...
        <section>
          ...
          {experiments.length === 0 ? (
              ...
              {hasAnyExperiments ? (
                ...
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-slate-400 text-sm mb-5">
                    Tu compañero para lograr metas con pequeños pasos diarios.
                  </p>

                  {/* Value props */}
                  <div className="text-left space-y-2.5 mb-6 px-4">
                    <div className="flex items-start gap-3">
                      <span className="text-indigo-400 mt-0.5">✓</span>
                      <span className="text-slate-300 text-sm">Descompone metas grandes en pasos claros</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-indigo-400 mt-0.5">✓</span>
                      <span className="text-slate-300 text-sm">Recordatorios diarios por WhatsApp</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-indigo-400 mt-0.5">✓</span>
                      <span className="text-slate-300 text-sm">Mantén rachas y celebra tu progreso</span>
                    </div>
                  </div>
                  ...
                  <Link
                    href="/vicu"
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-indigo-500 text-white font-medium hover:bg-indigo-400 transition-all shadow-lg shadow-indigo-500/25"
                  >
                  ...
                  {/* WhatsApp hint if not connected */}
                  {!whatsappConfigured && (
                    <p className="text-slate-500 text-xs mt-4">
                      Tip: Activa WhatsApp para recibir recordatorios diarios
                    </p>
                  )}
                </div>
              )}
            ...
            <div className="flex flex-col gap-2.5 sm:gap-3">
              {/* WhatsApp CTA Card - show if user has objectives but no WhatsApp */}
              {!whatsappConfigured && filteredExperiments.length > 0 && (
                <div
                  onClick={() => setShowWhatsappModal(true)}
                  className="group rounded-xl sm:rounded-2xl border border-emerald-500/30 bg-gradient-to-r from-emerald-950/40 to-emerald-900/20 px-4 py-4 sm:px-5 sm:py-5 cursor-pointer hover:border-emerald-500/50 transition-all"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm sm:text-base font-semibold text-emerald-300 group-hover:text-emerald-200 transition-colors">
                        Activa recordatorios por WhatsApp
                      </h3>
                      <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
                        Vicu te ayudará a mantener el ritmo con recordatorios diarios
                      </p>
                    </div>
                    <svg className="w-5 h-5 text-emerald-500 group-hover:text-emerald-400 transition-colors flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 max-w-sm w-full">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-white text-lg">Recordatorios WhatsApp</h3>
                  <p className="text-xs text-slate-400">Te enviamos recordatorios diarios</p>
                </div>
              </div>
              <button
                onClick={() => {
            ...
            <div className="space-y-5">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="relative" ref={countryDropdownRef}>
                    <button
                      ...
                      className="flex items-center gap-2 h-12 px-3 bg-slate-800 border border-slate-600 rounded-xl text-white hover:bg-slate-700 hover:border-slate-500 transition-all"
                    >
                        ...
                        <div className="p-3 border-b border-slate-700">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-2.5 bg-slate-900 border border-slate-600 rounded-lg text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                              autoFocus
                            />
                          </div>
                        </div>
              ...
              <button
                ...
                disabled={!whatsappPhoneInput.trim() || whatsappPhoneInput.length < 7 || whatsappLoading}
                className="w-full h-12 bg-emerald-600 text-white rounded-xl font-medium hover:bg-emerald-500 transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-emerald-600 flex items-center justify-center gap-2"
              >
                {whatsappLoading ? (
              ...
              <p className="text-xs text-slate-500 text-center">
                Recibirás recordatorios diarios para avanzar en tus objetivos
              </p>
            </div>
          </div>
        </div>
